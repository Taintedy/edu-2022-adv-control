...
class Animator3WRobot(Animator):
    ...
    def __init__(self, objects=[], pars=[]):
        ...
        est_xCoord0 = est_state_full_init[0]
        est_yCoord0 = est_state_full_init[1]
        est_alpha0 = est_state_full_init[2]
        est_v0 = est_state_full_init[3]
        est_omega0 = est_state_full_init[4]
    ...
    def animate(self, k):
        ...
        if self.is_playback:
            ...
            est_state_full = self.state_estimator.est_state(action, observation)
